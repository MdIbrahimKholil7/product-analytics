                    ...
                    <form className='flex items-center justify-center flex-col md:w-[45rem] w-[38rem] mx-auto'>
                        <div className='w-[80%] mx-auto'>
                            <div className='text-left w-full'>
                                ...
                                <input className='py-3 px-5 w-full mx-auto bg-slate-300 text-2xl rounded-lg outline-none mb-4 block placeholder:text-white' type="text" placeholder='Enter your name' />
                            </div>
                            <div className='text-left  w-full'>
                                <label className='text-2xl mb-[1rem] w-full mx-auto block' htmlFor="">Email</label>
                                <input className='py-3 px-5  w-full mx-auto bg-slate-300 text-2xl rounded-lg outline-none mb-4 block placeholder:text-white' type="text" placeholder='Enter your email' />
                            </div>
                            <div className='text-left  w-full '>
                                <label className='text-2xl  w-full mx-auto mb-[1rem] block' htmlFor="">Password</label>
                                <input className='py-3 px-5  w-full mx-auto bg-slate-300 text-2xl rounded-lg outline-none mb-4 block placeholder:text-white' type="password" placeholder='Enter your password' />
